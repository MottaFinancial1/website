...
export default function TeamDetails() {
  return (
    <>
      <Layout headerStyle={5} footerStyle={1} breadcrumbTitle="Nick Raccuia">
        <div>
                ...
                <div className="row align-items-center">
                  <div className="col-36">
                    <div className="team__details-img">
                      <img src="/assets/img/team/nick_team.jpeg" alt="" />
                    </div>
                  </div>
                  <div className="col-64">
                    <div className="team__details-content">
                      <h2 className="title">Nick Raccuia, CPA</h2>
                      <span className="position">Managing Director of Tax</span>
                      <p>
                        ...
                        specia.eed a little help from our friends from time to
                        time. Although we offer the one-stop onvenience of
                        annery integrated of legal, financial services under one
                        roofthere.
                      </p>
